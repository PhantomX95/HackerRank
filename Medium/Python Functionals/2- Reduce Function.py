...
# The ith of next n lines contain two integers each, the numerator(Ni) and denominator(Di) of the ith
...
# Output Format
# Print only one line containing the numerator and denominator of the product of the numbers in the list
# in its simplest form, i.e. numerator and denominator have no common divisor other than 1.
