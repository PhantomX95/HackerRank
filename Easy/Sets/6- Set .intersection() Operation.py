...
# one set has subscribed to the French newspaper. Your task is to find the total number of
# students who have subscribed to both newspapers.
...
# Constraints
# 0 < Total number of students in collage < 1000
