...
# of a linked list as a parameter. Complete removeDuplicates so that it deletes any duplicate nodes from
# the list and returns the head of the updated list.

# Note: The head pointer may be null, indicating that the list is empty. Be sure to reset your  pointer
# when performing deletions to avoid breaking the list.

# Input Format
# You do not need to read any input from stdin. The following input is handled by the locked stub code
